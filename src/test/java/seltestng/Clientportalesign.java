...
//	Thread.sleep(15000);
	...
	driver.findElement(By.xpath("(//span[normalize-space()='Esign 96 seer'])[1]")).click();
...
//	driver.findElement(By.xpath("(//span[contains (text(),' Next ')])[1]")).click();
//	Thread.sleep(13000);
	//WebElement frameone = driver.findElement(iframe);    //iframe field
//	driver.switchTo().frame(frameone);
	driver.switchTo().frame(0);
	Thread.sleep(3000);
	try {
		WebElement checkagree = driver.findElement(By.xpath("//span[normalize-space()='Required']"));
		boolean displayinfo = checkagree.isDisplayed();
		if(displayinfo) {
			checkagree.click();	
		}
	}
...
//	Thread.sleep(3000);
    ...
    Thread.sleep(4000);
    WebElement iscrolls = driver.findElement(By.xpath("//button[@class='btn btn-lg btn-main item-alt-inline-block'][normalize-space()='Adopt and Sign']"));
 	JavascriptExecutor Jscrf = (JavascriptExecutor) driver;
 	Jscrf.executeScript("arguments[0].scrollIntoView(true);" ,iscrolls);
    Thread.sleep(3000);
    driver.findElement(By.xpath("//button[@class='btn btn-lg btn-main item-alt-inline-block'][normalize-space()='Adopt and Sign']")).click();
    Thread.sleep(5000);
